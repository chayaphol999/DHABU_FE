          ...
          <tbody className="divide-y divide-slate-50 text-sm">
            {activeTab === 'Staff' && staff.map(s => (
              <tr key={s.id} className="hover:bg-slate-50/50 transition-colors">
                ...
                <td className="px-8 py-6 text-right">
                  <button onClick={() => onEditItem(s)} className="p-2 text-slate-300 hover:text-shabu-orange transition-colors">✎</button>
                </td>
              </tr>
            ))}
            {activeTab === 'Menu' && menu.map(m => (
              <tr key={m.id} className="hover:bg-slate-50/50 transition-colors">
                ...
                <td className="px-8 py-6 text-right">
                  <button onClick={() => onEditItem(m)} className="p-2 text-slate-300 hover:text-shabu-orange transition-colors">✎</button>
                </td>
              </tr>
            ))}
            {activeTab === 'Customers' && customers.map(c => (
              <tr key={c.id} className="hover:bg-slate-50/50 transition-colors">
                ...
                <td className="px-8 py-6 text-right">
                  <button onClick={() => onEditItem(c)} className="p-2 text-slate-300 hover:text-shabu-orange transition-colors">✎</button>
                </td>
              </tr>
            ))}
            ...
            {activeTab === 'TablesData' && tables.map(t => (
              <tr key={t.id} className="hover:bg-slate-50/50 transition-colors">
                ...
                <td className="px-8 py-6 text-right">
                  <button onClick={() => onEditItem(t)} className="p-2 text-slate-300 hover:text-shabu-orange transition-colors">✎</button>
                </td>
              </tr>
            ))}
          </tbody>
